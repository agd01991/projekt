...
<div class="first-text container"><h1>Отзыв не удалён</h1><h3>Произошла ошибка</h3><a class="btn btn-outline-light" href="../main.php" role="button">На главную</a>';
else // если все прошло нормально – выводим сообщение
echo ' <div class="first first-success" id="first">
<div class="first-text container"><h1>Отзыв удалён</h1><a class="btn btn-outline-light" href="../main.php" role="button">На главную</a>';
